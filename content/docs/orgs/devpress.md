...
## 第一步：进入组织设置，完成账号关联
* 点击右上角导航“组织设置” 进入组织设置页面
* 点击左侧导航“社区管理” - “社区设置”，进入“社区设置页面”页面，开始第一步。
* 需提前准备1个 Gitcode 账号 和 1个 CSDN 账号

![绑定账号](/docs/images/绑定账号.png)

## 第二步：进行社区申请（每个组织仅可申请1次）

* 请注意**每个组织仅可申请1次哦**
* 点击【立即申请】，填写申请理由后，会由Gitcode运营者审核，预计在1-3个工作日内审核完毕

![申请社区](/docs/images/申请社区.png)
...
在社区中的展示位置：
![社区文章展示](/docs/images/社区文章展示.jpg)

设置方法：
点击 “社区内容管理” - “立即设置”，进入社区设置后台。
![社区内容管理](/docs/images/社区内容管理.png)
![内容管理1](/docs/images/内容管理1.png)
**1.1 内容管理 ：**
...
在社区中的展示位置：
![运营活动前端展示](/docs/images/运营活动前端展示.png)

设置方法：
点击 “运营活动设置” - “立即设置”，进入社区设置后台。
![运营活动管理](/docs/images/运营活动管理.png)
![社区运营活动设置](/docs/images/社区运营活动设置.png)
**2.1 banner设置 ：**
...
在社区中的展示位置：
![导航栏展示](/docs/images/导航栏展示.png)

设置方法：
点击 “运营活动设置” - “立即设置”，进入社区设置后台。
![运营活动管理](/docs/images/运营活动管理.png)
![自定义导航栏设置](/docs/images/自定义导航栏设置.png)
**3.1 社区导航 ：**
...
![组织首页展示](/docs/images/组织首页展示.png)

**项目首页有2个展示位：** 逻辑与组织首页逻辑一致，但未展示活动日历

![项目首页展示](/docs/images/项目首页展示.png)


## 第五步：社区功能全面了解
全面了解社区功能，丰富社区内容。
![内容管理](/docs/images/内容管理.jpg)
